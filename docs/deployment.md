...
Uploaded images are represented by URLs. `src/lib/storage.ts` defines the adapter boundary; connect an object storage provider before enabling file upload controls in the CMS.
